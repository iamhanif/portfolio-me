"use client";
import proPic from "@/images/hanif.png";
...
const HeroSection = () => {
  ...
  return (
    <div
      id="about"
      className="relative h-dvh w-full p-6 md:p-12 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-all duration-500"
    >
